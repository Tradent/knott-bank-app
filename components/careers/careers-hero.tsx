      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
            ...
            <span className="bg-gradient-to-r from-green-400 to-green-300 bg-clip-text text-transparent">Career</span>
            <span className="text-white"> With Us</span>
          </h1>
          <p className="text-xl text-gray-300 mb-8">
            Join our team of innovators shaping the future of finance. We're looking for passionate individuals who want
            to make an impact.
          </p>
        </div>
      </div>

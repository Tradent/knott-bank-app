    ...
    <section className="py-16 px-4 bg-white">
      <div className="container mx-auto max-w-4xl">
        <div className="prose prose-lg max-w-none">
          <p className="lead">
            This Cookie Policy explains how Knott Bank ("we", "us", or "our") uses cookies and similar technologies to
          ...
          <p>
            Cookies set by the website owner (in this case, Knott Bank) are called "first-party cookies". Cookies set by
          ...
          <p>
            Email: privacy@knottbank.com
            <br />
            Address: 123 Financial District, New York, NY 10004
            <br />
            Phone: +1 (800) 555-KNOTT
          </p>
        </div>
      </div>
    </section>

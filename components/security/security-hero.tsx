      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
            ...
            <span className="bg-gradient-to-r from-green-400 to-green-300 bg-clip-text text-transparent">Security</span>
          </h1>
          <p className="text-xl text-gray-300 mb-8">
            At Knott Bank, we prioritize the security of your assets above all else. Our multi-layered security approach
            combines the best of blockchain technology with traditional security measures.
          </p>
        </div>
      </div>
    </section>

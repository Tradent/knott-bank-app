      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
            <span className="text-white">Crypto Banking </span>
            <span className="bg-gradient-to-r from-green-400 to-green-300 bg-clip-text text-transparent">Features</span>
          </h1>
          <p className="text-xl text-gray-300 mb-8">
            Discover how Knott Bank combines the best of traditional banking with the innovation of decentralized
            finance.
          </p>
        </div>
      </div>
